...
const LoginPage = () => {
  ...
  const [email, setEmail] = useState('admin_alfalah@example.com');
  ...
  return (
    <div className="text-on-surface min-h-screen relative overflow-hidden flex items-center justify-center p-md">
      ...
      <main className="w-full max-w-[440px] relative z-10">
        ...
        <div className="absolute -top-12 left-1/2 -translate-x-1/2 w-24 h-24 bg-primary rounded-2xl shadow-lg shadow-primary/20 border-4 border-background flex items-center justify-center z-20 rotate-3">
