...
// Lazy-load chart section — recharts (~412KB) only downloads
// when this component renders, not on initial landing page load.
const LandingCharts = React.lazy(() => import('../components/landing/LandingCharts'));
    ...
    <div className="min-h-screen bg-background text-on-surface font-body relative overflow-x-hidden">
      ...
      <div className="relative z-10 pt-36 pb-20 px-6 lg:px-16 max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="w-full flex flex-col xl:flex-row gap-8">
          ...
          {/* Analytics Grid (2x2) — lazy-loaded to defer recharts (~412KB) */}
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Suspense fallback={
              ...
              <LandingCharts
                jemaahTrendData={jemaahTrendData}
