      ...
      <div className="flex items-center gap-md">
        <div className="flex items-center gap-sm">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {/* Dropdown Panel */}
            {showDropdown && (
              <div className="absolute right-0 mt-2 w-96 bg-[#0f1923] border border-outline-variant rounded-xl shadow-2xl overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200">
                {/* Header */}
