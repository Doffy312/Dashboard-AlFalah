      ...
      },
      {
        onSuccess: (res) => {
          ...
          if (onSuccessCallback) {
            onSuccessCallback(`Donasi ${donasiType} sebesar ${formatCurrency(finalAmount)} berhasil dicatat & masuk ke menu ZISWAF (Menunggu Verifikasi)!`);
          }
        }
      }
    );
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-5 rounded-2xl border-2 border-emerald-500/40 text-center shadow-2xl space-y-3 text-slate-900 relative overflow-hidden">
                ...
                <div className="pt-2 px-1 space-y-2">
                  ...
                  <div className="text-[10px] text-slate-500 flex items-center justify-center gap-1.5 pt-1 border-t border-slate-100 font-medium flex-wrap">
