        ...
        <div className="flex gap-sm shrink-0 overflow-x-auto pb-1 sm:pb-0 hide-scrollbar">
          {filters.map((filter, index) => (
            <select
              ...
              className="px-sm py-[10px] bg-surface-variant border border-outline rounded-xl outline-none focus:border-primary text-on-surface font-body-md min-w-[120px] appearance-none cursor-pointer"
