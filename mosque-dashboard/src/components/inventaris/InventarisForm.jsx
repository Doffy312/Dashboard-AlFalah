      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-md">
        ...
        <div className="flex flex-col sm:flex-row gap-md">
          ...
          <div className="flex flex-col gap-xs flex-1">
            ...
            <select 
              className="w-full px-md py-sm bg-white/50 dark:bg-black/20 border border-white/40 dark:border-white/10 rounded-xl outline-none focus:border-primary text-on-surface dark:text-white font-body-md appearance-none cursor-pointer"
        ...
        <div className="flex flex-col gap-xs">
          ...
          <div className="flex gap-2">
            {conditions.map(cond => (
              <label key={cond} className={`flex-1 flex items-center justify-center p-2 rounded-lg border cursor-pointer transition-all font-label-md text-[13px] ${formData.condition === cond ? 'border-primary bg-primary/10 text-primary dark:text-primary-fixed' : 'border-white/20 dark:border-white/10 text-on-surface-variant hover:bg-white/10'}`}>
                <input 
                  type="radio" 
                  name="condition" 
                  value={cond} 
