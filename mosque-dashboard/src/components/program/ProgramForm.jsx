      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-md">
        ...
        {formData.status === 'Selesai' && (
          <div className="flex flex-col gap-xs p-md bg-emerald-500/10 border border-emerald-500/20 rounded-xl mt-xs">
            ...
            <textarea 
              rows="2"
              className="w-full px-md py-sm bg-white/50 dark:bg-black/20 border border-emerald-500/30 rounded-xl outline-none focus:border-emerald-500 text-on-surface dark:text-white font-body-md resize-none"
